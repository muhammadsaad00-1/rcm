...
const reviews = [
    { text: '"RenoxMed dropped our denial rate dramatically. We recovered significant revenue we didn\'t know we were losing."', name: 'Dr. Rachel Torres, MD', role: 'Cardiology Associates · Ohio, USA', init: 'RT', bg: 'linear-gradient(135deg,#0B1437,#162257)' },
    { text: '"Our AR days dropped significantly early on. The specialty coding expertise is exactly what a 3-location orthopedic group needs."', name: 'James Kowalski', role: 'Admin Director · Summit Orthopedics · IL', init: 'JK', bg: 'linear-gradient(135deg,#00C9A7,#0B1437)' },
    { text: '"Zero telehealth claim denials consistently. They stay ahead of every payer-specific rule change before it impacts our collections."', name: 'Dr. Anita Patel, LCSW', role: 'ClearMind Behavioral Health · CA', init: 'AP', bg: 'linear-gradient(135deg,#F5A623,#C17D00)' },
    { text: '"The transition went smoothly and quickly and we didn\'t miss a single claim. Our collections increased significantly within months."', name: 'Dr. Michael Brown', role: 'Family Practice · Atlanta, GA', init: 'MB', bg: 'linear-gradient(135deg,#27AE60,#1A7040)' },
    ...
    { text: '"Before RenoxMed, we had a large amount in unpaid claims over 90 days. Within months, they recovered the vast majority of it."', name: 'Dr. David Park, MD', role: 'Pacific Neurology · San Diego, CA', init: 'DP', bg: 'linear-gradient(135deg,#00C9A7,#162257)' },
];
