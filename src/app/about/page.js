...
export default function AboutPage() {
    return (
        <>
            ...
            <PageHero tag="🏢 Our Story" title="About" titleAccent="RenoxMed" description="Founded in 2012 by healthcare administrators who watched millions slip through billing inefficiencies — and decided to fix it." />
            <section className="section"><div className="container">
                <div className="about-story">
                    <div>
                        <div className="sec-label">Our Story</div>
                        <h2 className="sec-title">Built by Billers, for Clinicians</h2>
                        <p style={{ color: 'var(--text3)', lineHeight: 1.8, marginBottom: 16 }}>RenoxMed was founded after our CEO spent 14 years as a practice administrator watching healthcare providers lose hundreds of thousands of dollars annually to billing errors, coding inefficiencies, and uncollected claims.</p>
                        ...
                        <p style={{ color: 'var(--text3)', lineHeight: 1.8, marginBottom: 28 }}>Today, RenoxMed serves 1,200+ providers across 40+ specialties, processing over $2.8 billion in annual claims from our US-based headquarters in Dallas, TX.</p>
                ...
                <div style={{ marginTop: 80 }}><div className="sec-label" style={{ justifyContent: 'center', display: 'flex' }}>Leadership</div><h2 className="sec-title center">The Team Behind RenoxMed</h2></div>
                <div className="team-grid">
                    <div className="team-card"><div className="team-av" style={{ background: 'linear-gradient(135deg,#0B1437,#162257)' }}>MW</div><h4>Marcus Webb</h4><span className="team-role">CEO & Co-Founder</span><p className="team-bio">14 years practice administration. MBA Healthcare Management. Founded RenoxMed to fix what's broken in medical billing.</p></div>
            ...
            <CtaBanner title="Join 1,200+ Practices That Trust RenoxMed" description="Start with a free, no-pressure billing audit." primaryText="Get Your Free Audit" primaryHref="/contact" />
            <MiniFooter />
        </>
    );
}
