                ...
                <div className="container">
                    <div className="contact-layout">
                        <div className="contact-info">
                            ...
                            <div className="cinfo-card"><div className="cinfo-ico">✉</div><div><div className="cinfo-label">Email</div><div className="cinfo-val">info@clearclaim.com</div><div className="cinfo-note">Response within 2 business hours</div></div></div>
