...
const faqs = [
    { q: 'How quickly can RenoxMed take over our billing?', a: 'Most practices go live within 10–14 business days. We handle the full transition — EHR integration, payer credentialing review, and staff coordination — with zero downtime to your existing billing workflow.' },
    ...
    { q: 'Is RenoxMed HIPAA compliant?', a: 'Yes, fully. We operate under signed Business Associate Agreements (BAAs), use 256-bit AES encryption for all data, and undergo annual SOC 2 Type II and HIPAA compliance audits by independent third-party firms. All staff receive annual HIPAA security training.' },
