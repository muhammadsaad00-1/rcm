            ...
            <section className="section">
                <div className="container">
                    <div className="svc-overview-grid">
                        ...
                        <Link href="/services/billing" className="svc-ov-card"><div className="svc-ov-ico">🏷️</div><h3>Medical Billing</h3><p>Accurate CPT/ICD-10 coding, claim preparation and 48-hour electronic submission to all major payers.</p><div className="svc-link">Full Details →</div></Link>
                        ...
                        <Link href="/services/denial" className="svc-ov-card"><div className="svc-ov-ico">🚫</div><h3>Denial Management</h3><p>Every denial categorized, appealed within 48 hours with trend analysis to prevent recurrence.</p><div className="svc-link">Full Details →</div></Link>
                        <Link href="/services/ar" className="svc-ov-card"><div className="svc-ov-ico">💰</div><h3>Account Receivable</h3><p>Systematic follow-up on aged claims. We work claims up to 365 days old and pursue every dollar.</p><div className="svc-link">Full Details →</div></Link>
