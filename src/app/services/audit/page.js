                ...
                <div className="container">
                    <div className="svc-detail-section">
                        <div>
                            ...
                            <p style={{ color: 'var(--text3)', lineHeight: 1.75, marginBottom: 22 }}>Our certified billing auditors examine your claims history, identify patterns of undercoding and overcoding, flag compliance vulnerabilities, and benchmark your performance against specialty-specific standards.</p>
                            ...
                            <div className="info-box" style={{ marginTop: 28 }}>
                                ...
                                <p>The average medical practice loses a significant portion of revenue to billing errors and inefficiencies. Our audit typically reveals significant recoverable annual revenue.</p>
                            </div>
                        </div>
                    ...
                    <div className="svc-detail-section">
                        ...
                        <div>
                            ...
                            <div className="process-steps">
                                <div className="step-item"><div className="step-num">1</div><div className="step-body"><h4>Data Collection & Access</h4><p>Secure HIPAA-compliant access to your EHR/billing system. We pull your claims data for analysis.</p></div></div>
                                ...
                                <div className="step-item"><div className="step-num">5</div><div className="step-body"><h4>Live Presentation & Recommendations</h4><p>A detailed call with your team to walk through findings and create a revenue recovery roadmap.</p></div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="grid-2 grid-align" style={{ gap: 60 }}>
                        <div>
                            ...
                            <p className="sec-sub">Complete the form and a billing audit specialist will contact you promptly to schedule your complimentary practice review.</p>
                            <div style={{ marginTop: 28 }}>
                                <div className="cinfo-card"><div className="cinfo-ico">⏱️</div><div><div className="cinfo-label">Turnaround</div><div className="cinfo-val">Results delivered promptly</div></div></div>
